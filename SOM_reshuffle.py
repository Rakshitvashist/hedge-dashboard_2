...
# constituents. Each month only the stocks ACTUALLY in Nifty 50 that month are
# eligible (membership from the reshuffle tracker) -> no survivorship bias.
STOCKS_FOLDERS   = ["nifty50_host", "nifty50_hist"]  # loaded together
STOCKS_FOLDER    = STOCKS_FOLDERS[0]                  # kept for any legacy refs
MEMBERSHIP_FILE  = "nifty50_reshuffle_tracker_v2.xlsx"
MEMBERSHIP_ALIAS = {"BAJAJAUTO": "BAJAJ-AUTO"}
BOND_FILE        = "India 1-Year Bond Yield Historical Data.csv"  # Risk-free rate
BENCHMARK_FILE   = "NIFTY50_1d.csv"  # Benchmark index

# Output files
OUTPUT_FILE      = "SOM_Reshuffle_PointInTime.xlsx"          # Main comprehensive report
SUMMARY_ONLY_FILE = "SOM_Reshuffle_PointInTime_Summary.xlsx" # Summary-only report
CURRENT_PORT_FILE = "SOM_Reshuffle_PointInTime_Current.xlsx" # Latest trading instructions
