...
STOCKS_FOLDER    = "TOTAL_STOCKS"  # Folder with daily CSV files
BOND_FILE        = "India 1-Year Bond.csv"  # Risk-free rate
BENCHMARK_FILE   = "NIFTY50_INDEX.csv"  # Benchmark index

# Output files
OUTPUT_FILE      = "Sharpe_Total_stocks515151.xlsx"  # Main comprehensive report
SUMMARY_ONLY_FILE = "Sharpe_Summary_Total_stocks51515151.xlsx"  # Summary-only report
CURRENT_PORT_FILE = "Current_Portfolio_Total_stocks515151.xlsx" # NEW: Latest trading instructions
